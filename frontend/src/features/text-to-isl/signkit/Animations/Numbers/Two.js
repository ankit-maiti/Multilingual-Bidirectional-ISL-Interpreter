export const Two = (ref) => {
    ...
    // Right Hand: Index + Middle Up (2)
    const straightFingers = ["mixamorigRightHandIndex", "mixamorigRightHandMiddle"];
    ...
    const curledFingers = ["mixamorigRightHandRing", "mixamorigRightHandPinky"];
